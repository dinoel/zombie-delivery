...
if (-not (Get-Command node -ErrorAction SilentlyContinue)) {
  ...
  $flamethrowerTest = & node (Join-Path $PSScriptRoot 'test-flamethrower.js') 2>&1
  if ($LASTEXITCODE -ne 0) {
    $problems.Add("Flamethrower test failed:`n$flamethrowerTest")
  }
}
...
$expectedScripts = @(
  'src/namespace.js?v=20260803-82',
  'src/config.js?v=20260803-82',
  'src/core.js?v=20260803-82',
  'src/quality.js?v=20260803-82',
  'src/audio.js?v=20260803-82',
  'src/car-physics.js?v=20260803-82',
  'src/environment.js?v=20260803-82',
  'src/world.js?v=20260803-82',
  'src/physics.js?v=20260803-82',
  'src/input.js?v=20260803-82',
  'src/gameplay.js?v=20260803-82',
  'src/lighting.js?v=20260803-82',
  'src/entities.js?v=20260803-82',
  'src/render.js?v=20260803-82',
  'src/net.js?v=20260803-82',
  'src/main.js?v=20260803-82'
)
